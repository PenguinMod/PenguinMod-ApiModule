...
class PenguinModAPIMisc {
    ...
    async getStats() {
        return await utils.doBasicRequest(
            `${this._parent.apiUrl}/v1/misc/getStats`,
            null,
            this._parent,
    ...
    async getLastPolicyUpdate() {
        return await utils.doBasicRequest(
            `${this._parent.apiUrl}/v1/misc/getLastPolicyUpdate`,
            null,
            this._parent,
            utils.RequestType.JSON,
        );
    ...
    async getLastPolicyRead() {
        const url = `${this._parent.apiUrl}/v1/misc/getLastPolicyRead?token=${encodeURIComponent(this._parent.token)}`;
        utils.assert(
            !!this._parent.token,
            url,
            "Reauthenticate",
